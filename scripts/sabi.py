...
SUSHI = [
 ...
 _nigiri("tako",    (190, 120, 190), (238, 206, 238),       # octopus, sucker dots
         pattern=(2, 1, 3, 1, 5)),
 ("tako karaage", (222, 160, 72), [               # little fried octopus, tentacles dangling
   [("   ", None), ("▄██████▄", (222, 160, 72))],
   [("  ", None), ("██", (222, 160, 72)), ("██", (244, 196, 120)), ("██", (222, 160, 72)),
    ("██", (244, 196, 120)), ("██", (222, 160, 72))],
   [(" ", None), ("█▌", (186, 124, 52)), (" ", None), ("█", (222, 160, 72)), (" ", None),
    ("██", (222, 160, 72)), (" ", None), ("█", (222, 160, 72)), (" ", None), ("▐█", (186, 124, 52))],
   [("  ", None), ("▀", (186, 124, 52)), ("  ", None), ("▀", (186, 124, 52)), (" ", None),
    ("▀", (186, 124, 52)), ("  ", None), ("▀", (186, 124, 52))]]),
 _nigiri("hotate",  (246, 238, 222), (224, 210, 188)),      # scallop, soft ridges
 ("ebi", ORANGE, [
   [("  ", None), ("▄▄▚▚▄▄▚▚▄▄", ORANGE)],
   [(" ", None), ("██▚▚██▚▚████", ORANGE)],
   [(" ", None), ("████████████", _RICE)],
 ...
 ("tamago", _TAMA, [
   ...
   [("  ", None), ("▀▀▀▀▀▀▀▀▀▀", _RICE)]]),
 ("unagi", (150, 96, 48), [                        # glazed eel, nori strap, rice
   [("  ", None), ("▄▄▄▄▄▄▄▄▄▄", (150, 96, 48))],
   [(" ", None), ("██", (150, 96, 48)), ("█", (198, 140, 72)), ("█", (150, 96, 48)),
    ("███", _NORI), ("██", (150, 96, 48)), ("█", (198, 140, 72)), ("██", (150, 96, 48))],
   [(" ", None), ("████", _RICE), ("███", _NORI), ("█████", _RICE)],
   [("  ", None), ("▀▀▀▀▀▀▀▀▀▀", _RICE)]]),
 _gunkan("uni",   (255, 176, 32), "▄▄▄▄▄▄▄▄"),              # uni mound
 _gunkan("ikura", _ROE,           "●●●●●●●●"),              # roe pearls
 ("negitoro", (244, 150, 150), [                   # minced toro + spring onion, nori boat
   [("  ", None), ("▄▄", (244, 150, 150)), ("▄", (120, 200, 90)), ("▄▄▄", (244, 150, 150)),
    ("▄", (120, 200, 90)), ("▄", (244, 150, 150))],
   [(" ", None), ("▐████████▌", _NORI)],
   [(" ", None), ("▐████████▌", _NORI)],
   [("  ", None), ("▀▀▀▀▀▀▀▀", _NORI)]]),
 ...
 ("inari", (196, 140, 64), [                       # sweet tofu pouch, rice at the seam
   [("  ", None), ("▄▄", (196, 140, 64)), ("██████", _RICE), ("▄▄", (196, 140, 64))],
   [(" ", None), ("████████████", (196, 140, 64))],
   [(" ", None), ("███", (196, 140, 64)), ("██", (222, 168, 88)), ("███", (196, 140, 64)),
    ("██", (222, 168, 88)), ("██", (196, 140, 64))],
   [("  ", None), ("▀▀▀▀▀▀▀▀▀▀", (160, 108, 48))]]),
 ("temaki", (140, 190, 90), [                     # hand roll: nori cone, ikura + avocado
   [("      ", None), ("●●●", _ROE), ("▄▄", (140, 190, 90))],
   [("    ", None), ("▄▄", (46, 68, 44)), ("██", (240, 242, 248)), ("████", (46, 68, 44))],
   [("   ", None), ("█████████", (70, 118, 70))],
   [("  ", None), ("███████", (46, 68, 44))],
   [(" ", None), ("████", (38, 56, 36))]]),
 ("futomaki", _NORI, [                             # thick roll: egg, cucumber, fish core
   [("  ", None), ("▄██████████▄", _NORI)],
   [(" ", None), ("██", _NORI), ("██", _RICE), ("██", _TAMA), ("██", (140, 190, 90)),
    ("██", ORANGE), ("██", _RICE), ("██", _NORI)],
   [(" ", None), ("██", _NORI), ("██", _RICE), ("██", ORANGE), ("██", _TAMA),
    ("██", (140, 190, 90)), ("██", _RICE), ("██", _NORI)],
   [("  ", None), ("▀██████████▀", _NORI)]]),
 ("uramaki", _RICE, [
   [("  ", None), ("▄████████▄", _RICE)],
